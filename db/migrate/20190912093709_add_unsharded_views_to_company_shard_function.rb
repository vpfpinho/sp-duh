class AddUnshardedViewsToCompanyShardFunction < ActiveRecord::Migration
  def up
    # we will not replace sharding.get_auxiliary_table_information because we know it is being overriden on toconline, and it's on this gem as template only
    execute <<-'SQL'
