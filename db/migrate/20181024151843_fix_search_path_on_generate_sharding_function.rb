class FixSearchPathOnGenerateShardingFunction < ActiveRecord::Migration
  def up
    execute <<-'SQL'
  ...
  def down
    puts "Not reverting function sharding.generate_create_company_shard_function into buggy version".green
  end
end
