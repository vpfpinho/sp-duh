class AddedAParameterToDetermineWhetherToGenerateDeleteQueries < ActiveRecord::Migration
  def up
  ...
  def down
    execute %Q[DROP FUNCTION IF EXISTS sharding.shard_table_data(TEXT, TEXT, INTEGER, TEXT, TEXT, TEXT);]
    execute %Q[DROP FUNCTION IF EXISTS sharding.shard_table_data(TEXT, TEXT, INTEGER, TEXT, TEXT, TEXT, BOOLEAN);]
